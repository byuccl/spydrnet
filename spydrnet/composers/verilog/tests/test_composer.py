...
class TestVerilogComposer(unittest.TestCase):
    ...
    def test_simple_compose(self):
        ...
        vp = sdn.parsers.verilog.parser.VerilogParser.from_filename("/home/dallin/Documents/byuccl/SpyDrNet/spydrnet/support_files/verilog_netlists/basic_synchronization.v.zip")
        netlist = vp.parse()
        comp = Composer()
