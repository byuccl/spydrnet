class GetterShortcuts:
    ...
    def get_libraries(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_libraries(`.
        """
    ...
    def get_definitions(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_definitions`.
        """
    ...
    def get_instances(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_instances`.
        """
    ...
    def get_ports(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_ports`.
        """
    ...
    def get_pins(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_pins`.
        """
    ...
    def get_cables(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_cables`.
        """
    ...
    def get_wires(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_wires`.
        """
    ...
    def get_hinstances(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_hinstances`.
        """
    ...
    def get_hports(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_hports`.
        """
    ...
    def get_hpins(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_hpins`.
        """
    ...
    def get_hcables(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_hcables`.
        """
    ...
    def get_hwires(self, *args, **kwargs):
        ...
        Shortcut to :func:`~spydrnet.util.get_hwires`.
        """
